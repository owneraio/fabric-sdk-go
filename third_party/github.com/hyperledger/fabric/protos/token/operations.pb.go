...
func (*TokenOperation) Descriptor() ([]byte, []int) {
	return fileDescriptor_operations_019bb882640dd787, []int{0}
}
...
func (dst *TokenOperation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TokenOperation.Merge(dst, src)
}
...
func (*TokenOperation) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _TokenOperation_OneofMarshaler, _TokenOperation_OneofUnmarshaler, _TokenOperation_OneofSizer, []interface{}{
		(*TokenOperation_Action)(nil),
	}
}

func _TokenOperation_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*TokenOperation)
	// Operation
	switch x := m.Operation.(type) {
	case *TokenOperation_Action:
	...
	case nil:
	default:
		return fmt.Errorf("TokenOperation.Operation has unexpected type %T", x)
	}
	return nil
}

func _TokenOperation_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*TokenOperation)
	switch tag {
	case 1: // Operation.Action
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(TokenOperationAction)
		err := b.DecodeMessage(msg)
		m.Operation = &TokenOperation_Action{msg}
		return true, err
	default:
		return false, nil
	}
...
func _TokenOperation_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*TokenOperation)
	// Operation
	switch x := m.Operation.(type) {
	case *TokenOperation_Action:
...
func (*TokenOperationAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_operations_019bb882640dd787, []int{1}
}
...
func (dst *TokenOperationAction) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TokenOperationAction.Merge(dst, src)
}
...
func (*TokenOperationAction) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _TokenOperationAction_OneofMarshaler, _TokenOperationAction_OneofUnmarshaler, _TokenOperationAction_OneofSizer, []interface{}{
		(*TokenOperationAction_Issue)(nil),
		(*TokenOperationAction_Transfer)(nil),
	}
}

func _TokenOperationAction_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*TokenOperationAction)
	// Payload
	switch x := m.Payload.(type) {
	case *TokenOperationAction_Issue:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Issue); err != nil {
			return err
		}
	case *TokenOperationAction_Transfer:
	...
	case nil:
	default:
		return fmt.Errorf("TokenOperationAction.Payload has unexpected type %T", x)
	}
	return nil
}

func _TokenOperationAction_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*TokenOperationAction)
	switch tag {
	case 1: // Payload.Issue
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(TokenActionTerms)
		err := b.DecodeMessage(msg)
		m.Payload = &TokenOperationAction_Issue{msg}
		return true, err
	case 2: // Payload.Transfer
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(TokenActionTerms)
		err := b.DecodeMessage(msg)
		m.Payload = &TokenOperationAction_Transfer{msg}
		return true, err
	default:
		return false, nil
	}
...
func _TokenOperationAction_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*TokenOperationAction)
	// Payload
	switch x := m.Payload.(type) {
	case *TokenOperationAction_Issue:
...
func (*TokenActionTerms) Descriptor() ([]byte, []int) {
	return fileDescriptor_operations_019bb882640dd787, []int{2}
}
...
func (dst *TokenActionTerms) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TokenActionTerms.Merge(dst, src)
}
...
var fileDescriptor_operations_019bb882640dd787 = []byte{
