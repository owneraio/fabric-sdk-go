...
func init() {
	...
	proto.RegisterMapType((map[string]*ConfigGroupSchema)(nil), "sdk.common.ConfigGroupSchema.GroupsEntry")
	proto.RegisterMapType((map[string]*ConfigPolicySchema)(nil), "sdk.common.ConfigGroupSchema.PoliciesEntry")
	proto.RegisterMapType((map[string]*ConfigValueSchema)(nil), "sdk.common.ConfigGroupSchema.ValuesEntry")
	...
	proto.RegisterMapType((map[string][]byte)(nil), "sdk.common.ConfigUpdate.IsolatedDataEntry")
	proto.RegisterType((*ConfigGroup)(nil), "sdk.common.ConfigGroup")
	proto.RegisterMapType((map[string]*ConfigGroup)(nil), "sdk.common.ConfigGroup.GroupsEntry")
	proto.RegisterMapType((map[string]*ConfigPolicy)(nil), "sdk.common.ConfigGroup.PoliciesEntry")
	proto.RegisterMapType((map[string]*ConfigValue)(nil), "sdk.common.ConfigGroup.ValuesEntry")
